...
class TestVisibilityHistogramAnalyticsParameters:
    ...
    def test_start_must_be_less_than_end(self):
        ...
        assert "start_unix" in str(exc_info.value).lower() or "must be less than" in str(exc_info.value).lower()
    ...
    def test_bin_duration_must_be_positive(self):
        ...
        assert "bin_duration" in str(exc_info.value).lower() or "positive" in str(exc_info.value).lower()
...
class TestPopulateVisibilityTimeBinsParameters:
    ...
    def test_accepts_optional_bin_duration(self):
        ...
        assert params['bin_duration_seconds'].default is not inspect.Parameter.empty or \
               params['bin_duration_seconds'].default is None
