...
mod tests {
    ...
    fn test_module_structure() {
        ...
        assert_eq!(super::timeline::GET_SCHEDULE_TIMELINE_DATA, "get_schedule_timeline_data");
        assert_eq!(super::trends::GET_TRENDS_DATA, "get_trends_data");
        assert_eq!(super::validation::GET_VALIDATION_REPORT, "get_validation_report");
        assert_eq!(super::landing::LIST_SCHEDULES, "list_schedules");
        assert_eq!(super::landing::POST_SCHEDULE, "store_schedule");
        assert_eq!(super::visibility::GET_VISIBILITY_MAP_DATA, "get_visibility_map_data");
        assert_eq!(super::visibility::GET_SCHEDULE_TIME_RANGE, "get_schedule_time_range");
        assert_eq!(super::visibility::GET_VISIBILITY_HISTOGRAM, "get_visibility_histogram");
    }
}
