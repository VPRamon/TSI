...
mod dark_periods_parser_tests {
    use crate::parsing::dark_periods_parser::{parse_dark_periods_file, parse_dark_periods_str, periods_to_dataframe};
    use std::io::Write;
    ...
    fn test_parse_flat_array() {
        ...
        assert!(result.is_ok(), "Should parse flat array: {:?}", result.err());
    ...
    fn test_parse_nested_dark_periods() {
        ...
        let result = parse_dark_periods_str(json);
        assert!(result.is_ok(), "Should parse nested format: {:?}", result.err());
        let periods = result.unwrap();
    ...
    fn test_parse_snake_case_keys() {
        ...
        let result = parse_dark_periods_str(json);
        assert!(result.is_ok(), "Should parse snake_case: {:?}", result.err());
        let periods = result.unwrap();
        assert_eq!(periods.len(), 1);
    }
    ...
    fn test_parse_nested_value_objects() {
        ...
        let result = parse_dark_periods_str(json);
        assert!(result.is_ok(), "Should parse nested value objects: {:?}", result.err());
        let periods = result.unwrap();
        assert_eq!(periods.len(), 1);
        assert_eq!(periods[0].start.value(), 61771.0);
    ...
    fn test_parse_iso_timestamps() {
        ...
        let result = parse_dark_periods_str(json);
        assert!(result.is_ok(), "Should parse ISO timestamps: {:?}", result.err());
        let periods = result.unwrap();
        assert_eq!(periods.len(), 1);
    ...
    fn test_reject_reversed_period() {
        ...
        let result = parse_dark_periods_str(json);
        assert!(result.is_ok(), "Should parse but filter out reversed: {:?}", result.err());
        let periods = result.unwrap();
    ...
    fn test_parse_mixed_periods() {
        ...
        let result = parse_dark_periods_str(json);
        assert!(result.is_ok(), "Should parse mixed periods: {:?}", result.err());
        let periods = result.unwrap();
    ...
    fn test_periods_to_dataframe() {
        ...
        assert!(result.is_ok(), "Should convert to DataFrame: {:?}", result.err());
        ...
        assert!(df.column("start_mjd").is_ok(), "Should have start_mjd column");
        assert!(df.column("stop_mjd").is_ok(), "Should have stop_mjd column");
        assert!(df.column("duration_hours").is_ok(), "Should have duration_hours column");
    ...
    fn test_periods_to_dataframe_months() {
        ...
        assert!(matches!(months.dtype(), polars::prelude::DataType::List(_)), 
    ...
    fn test_parse_periods_key() {
        ...
        let result = parse_dark_periods_str(json);
        assert!(result.is_ok(), "Should parse with 'periods' key: {:?}", result.err());
        let periods = result.unwrap();
        assert_eq!(periods.len(), 1);
    }
    ...
    fn test_parse_capitalized_key() {
        ...
        let result = parse_dark_periods_str(json);
        assert!(result.is_ok(), "Should parse with capitalized key: {:?}", result.err());
        let periods = result.unwrap();
        assert_eq!(periods.len(), 1);
    }
    ...
    fn test_parse_end_time_keys() {
        ...
        let result = parse_dark_periods_str(json);
        assert!(result.is_ok(), "Should parse with end/endTime: {:?}", result.err());
        let periods = result.unwrap();
        assert_eq!(periods.len(), 2);
    }
    ...
    fn test_parse_string_mjd() {
        ...
        let result = parse_dark_periods_str(json);
        assert!(result.is_ok(), "Should parse string MJD: {:?}", result.err());
        let periods = result.unwrap();
        assert_eq!(periods.len(), 1);
        assert_eq!(periods[0].start.value(), 61771.0);
    }
    ...
    fn test_parse_integer_mjd() {
        ...
        let result = parse_dark_periods_str(json);
        assert!(result.is_ok(), "Should parse integer MJD: {:?}", result.err());
        let periods = result.unwrap();
        assert_eq!(periods.len(), 1);
        assert_eq!(periods[0].start.value(), 61771.0);
    }
    ...
    fn test_parse_utc_suffix_keys() {
        ...
        let result = parse_dark_periods_str(json);
        assert!(result.is_ok(), "Should parse UTC suffix keys: {:?}", result.err());
        let periods = result.unwrap();
        assert_eq!(periods.len(), 2);
    }
    ...
    fn test_parse_naive_datetime() {
        ...
        let result = parse_dark_periods_str(json);
        assert!(result.is_ok(), "Should parse naive datetime: {:?}", result.err());
        let periods = result.unwrap();
        assert_eq!(periods.len(), 1);
    }
    ...
    fn test_parse_incomplete_array() {
        ...
        let result = parse_dark_periods_str(json);
        assert!(result.is_ok(), "Should parse but skip incomplete: {:?}", result.err());
        let periods = result.unwrap();
    ...
    fn test_parse_mjd_nested_key() {
        ...
        let result = parse_dark_periods_str(json);
        assert!(result.is_ok(), "Should parse mjd nested key: {:?}", result.err());
        let periods = result.unwrap();
        assert_eq!(periods.len(), 1);
    }
